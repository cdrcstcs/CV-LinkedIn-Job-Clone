...
class ApplicationFactory extends Factory
{
    ...
    protected $techCompanies = [
        [
            ...
            'description' => 'Amazon Web Services (AWS) is the leading cloud platform, offering over 200 fully featured services from data centers around the globe. AWS provides a vast array of cloud computing solutions, including computing power, storage options, and networking capabilities. Its extensive suite of tools enables organizations to run applications and services at scale, providing businesses with flexibility and agility. AWS has revolutionized the way companies approach IT infrastructure, allowing them to innovate faster while managing costs effectively. With services like Amazon EC2 for computing, Amazon S3 for storage, and Amazon RDS for database management, AWS supports startups to large enterprises in deploying applications seamlessly. The platform is known for its reliability, security, and comprehensive compliance capabilities, ensuring that data is protected and accessible only to authorized users. Furthermore, AWS continuously expands its offerings to meet the evolving needs of customers, making it a pivotal player in the cloud computing industry.',
